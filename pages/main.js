...
import { weatherCardDetails } from '../components/WeatherDetails.js';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  //     });
  //   }
  const createWeatherDetailsCard = () => {
    const cardItem = weatherCardDetails.createDetailsCard();
  ...
  //     return cardItem;
  //   };
  const weatherDetailsCards = new Section(createWeatherDetailsCard, weatherDetailsRoot);
  console.log(weatherDetailsCards);
  ...
  //     }
  //   });
  // weatherDetailsCards.renderCards();
